...
<html lang="ru">
  ...
  <body class="wellcome">
    <header>
      ...
      <!--<div class="container">
        <nav class="navbar navbar-light bg-light">-->
        <a class="navbar-brand  ml-5" href="/" style="font-size: 200%">
      ...
      <ul class="nav nav-justified" style="background: #D9D6D2; font-size: 120%">
        <li class="nav-item">
    ...
    <footer class="footer">
        <nav class="navbar navbar-light bg-light" style="text-align: center">
          <span class="navbar-text" style="color: #D9D5F2; height:40px; position: absolute; left: 0; width: 100%; background-color: black">
